...
ClapTrap::ClapTrap ( string name ) : name(name), hitPoints(100), energyPoints(50), attackDamage(20){
...
{
	COUT << "[" << a.getName() << "]" << " has" << a.getHitPoints() << " health points, " << a.getEnergyPoints() << " energy, " << a.getAttackDamage()
	<< " attack damage." << endl;
	return  COUT;
}
